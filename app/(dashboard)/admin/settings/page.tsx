              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateConfig("platform", "platformName", e.target.value)
                      }
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      type="number"
                      value={config.platform.maxFileUploadSizeMB}
                      onChange={(e) =>
                        updateConfig(
                          "platform",
                          "maxFileUploadSizeMB",
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateConfig("platform", "supportEmail", e.target.value)
                      }
                      className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-jiko-primary"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateConfig("platform", "supportPhone", e.target.value)
                      }
                      className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-jiko-primary"
                    />
                  </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateConfig("payments", "mpesaShortcode", e.target.value)
                    }
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-jiko-primary"
                  />
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Users must verify email to use platform
                      </p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Users must verify phone to use platform
                      </p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
