...
import { 
  ...
  CheckCircle, XCircle, AlertCircle, Loader, MessageSquare,
  Star, Filter, Search
} from 'lucide-react';
    ...
    <div className="min-h-screen ">
      <div className=" px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-1">Manage your bookings and track progress</p>
        </div>
            ...
            <div className="flex">
              {[...Array(5)].map((_, i) => (
                <Star
                  key={i}
                  size={16}
                  className={i < booking.review!.rating ? 'text-yellow-400 fill-current' : 'text-gray-300'}
                />
              ))}
            </div>
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-2">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900">KSH {booking.amount.toLocaleString()}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Platform Commission (10%)</span>
                <span className="font-medium text-orange-600">-KSH {booking.commission.toLocaleString()}</span>
              </div>
              <div className="flex justify-between pt-2 border-t">
                <span className="font-bold text-gray-900">Your Payout</span>
                <span className="font-bold text-green-600">KSH {booking.providerPayout.toLocaleString()}</span>
              </div>
            </div>
          </div>
